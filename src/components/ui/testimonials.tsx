...
export const quoteStatementClass = "text-balance font-semibold text-[var(--rm-ink)]";
...
export function QuoteMark({ className }: { className?: string }) {
  return (
    <span
      aria-hidden
      className={cn("select-none font-semibold leading-none text-white/10", className)}
