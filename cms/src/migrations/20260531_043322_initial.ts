...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_posts_category" AS ENUM('Strategy', 'Positioning', 'Performance', 'Brand systems');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_category" AS ENUM('Strategy', 'Positioning', 'Performance', 'Brand systems');
  ...
  CREATE TABLE "posts" (
  	...
  	"author" varchar DEFAULT 'R-M Editorial',
  	"read_time" varchar DEFAULT '6 min read',
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_author" varchar DEFAULT 'R-M Editorial',
  	"version_read_time" varchar DEFAULT '6 min read',
  ...
  CREATE TABLE "navigation_dropdown_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar NOT NULL,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'R-M — Marketing Agency',
  ...
  Sitemap: https://refined-narrative-lab.vercel.app/sitemap.xml',
  	"blog_meta_title" varchar DEFAULT 'Blog — R-M',
  ...
  ALTER TABLE "navigation_dropdown_links" ADD CONSTRAINT "navigation_dropdown_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."navigation"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "navigation_dropdown_links_order_idx" ON "navigation_dropdown_links" USING btree ("_order");
  CREATE INDEX "navigation_dropdown_links_parent_id_idx" ON "navigation_dropdown_links" USING btree ("_parent_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "navigation_dropdown_links" CASCADE;
